              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
					...
					PreparedStatement pstmt=con.prepareStatement("select * from cngstation where city=?");
                    ...
                    <div class="table-responsive-xl">
                        <table class="table text-nowrap mb-0">
                            ...
                            <tr>
                                ...
                                <th class="font-weight-semi-bold border-top-0 py-2">Mobile No.</th>
                                 ...
                                 <th class="font-weight-semi-bold border-top-0 py-2">Longitude</th>
                                  <th class="font-weight-semi-bold border-top-0 py-2">CNG Available</th>
                                  <th class="font-weight-semi-bold border-top-0 py-2">Book CNG</th>
                            </tr>
                            <%while(rs.next()){%>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td class="py-3"><a href="bookcng.jsp?mobile=<%=rs.getString(2)%>">Book</a></td>
                            </tr>
