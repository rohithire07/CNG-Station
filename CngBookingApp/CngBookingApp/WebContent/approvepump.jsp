                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
					<% Connection con=DbConnection.connect();
 					...
 					PreparedStatement pstmt=con.prepareStatement("select * from cngstation where Status='Pending'");
                        ...
                        <table class="table text-nowrap mb-0">
                            ...
                            <tr>
                                ...
                                <th class="font-weight-semi-bold border-top-0 py-2">Mobile No.</th>
                                 ...
                                 <th class="font-weight-semi-bold border-top-0 py-2">Approve</th> 
                            </tr>
                            <%while(rs.next()){%>
                            </thead>
                            <tbody>
                            <tr>
                                 ...
                                 <td class="py-3"><span class="badge badge-pill badge-success"><%=rs.getString(12) %></td>
                                  <td><a href="status.jsp?mono=<%=rs.getString(2) %>">Approve</a></td>
