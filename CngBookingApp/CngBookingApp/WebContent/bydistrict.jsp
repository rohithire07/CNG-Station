              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
					...
					PreparedStatement pstmt=con.prepareStatement("select * from cngstation where district=?");
                    ...
                    <div class="table-responsive-xl">
                        <table class="table text-nowrap mb-0">
                            ...
                            <tr>
                                 ...
                                 <td class="py-3"><span class="badge badge-pill badge-success"><%=rs.getString(11) %></td>
